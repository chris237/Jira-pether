...
class Company(models.Model):
    ...
    ks_preexisting_account = fields.Many2one('account.account', string="Pre-existing Conditions Account")
...
class KSResConfigSettings(models.TransientModel):
    ...
    ks_preexisting_account = fields.Many2one('account.account', string="Preexisting Conditions Account", related='company_id.ks_preexisting_account', readonly=False)
